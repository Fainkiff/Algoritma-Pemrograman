...
print("Program untuk membuat file Mean dan STD")

judul = str(input("Masukan nama file : "))
filename = (f"{judul}.csv")
f = open(filename, "w")
f.close()
print(f"File {filename} telah dibuat")
print("TEKAN X atau x untuk menghentikan program")
print("===============================================")
...
while baris == True:
    ...
    print('masukan 0 untuk menyimpan file')
    print("masukan 1 untuk mencari dan menulis file mean")
    print("masukan 2 untuk mencari dan menulis file std ")
